...
export default function VocabularyQuizGame() {
  ...
  const handleQuizComplete = () => {
    navigate("/vocabulary-quiz/result", {
      state: { answers, questions: vocabularyQuestions },
    });
  };

  const progress = ((currentQuestion + 1) / vocabularyQuestions.length) * 100;
    ...
    <div className="min-h-screen bg-[#F5F9FF]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            {currentQuestion === vocabularyQuestions.length - 1 ? "Finish Quiz" : "Next"}
