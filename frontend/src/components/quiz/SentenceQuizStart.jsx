...
export default function SentenceQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Practice sentence formation, word order, and sentence correctness with 10 structure-based questions.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/sentence-quiz/play")}
