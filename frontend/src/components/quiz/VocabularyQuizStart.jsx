...
export default function VocabularyQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Test your knowledge of essential English words and meanings with 10 vocabulary-based questions.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/vocabulary-quiz/play")}
