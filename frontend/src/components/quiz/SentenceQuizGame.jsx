...
export default function SentenceQuizGame() {
  ...
  const handleQuizComplete = () => {
    navigate("/sentence-quiz/result", {
      state: { answers, questions: sentenceQuestions },
    });
  };

  const progress = ((currentQuestion + 1) / sentenceQuestions.length) * 100;
  const question = sentenceQuestions[currentQuestion];
    ...
    <div className="min-h-screen bg-[#F5F9FF]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            {currentQuestion === sentenceQuestions.length - 1 ? "Finish Quiz" : "Next"}
