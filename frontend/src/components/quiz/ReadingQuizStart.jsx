...
export default function ReadingQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Improve reading comprehension with 10 short passage and meaning-based English questions.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/reading-quiz/play")}
