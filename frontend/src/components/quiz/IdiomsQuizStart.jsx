...
export default function IdiomsQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Learn common English idioms and understand their real-life meanings with 10 idiom-based questions.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/idioms-quiz/play")}
