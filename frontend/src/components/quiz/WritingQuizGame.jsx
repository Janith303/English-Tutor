...
export default function WritingQuizGame() {
  ...
  const handleQuizComplete = () => {
    navigate("/writing-quiz/result", {
      state: { answers, questions: writingQuestions },
    });
  };
    ...
    <div className="min-h-screen bg-[#F5F9FF]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            {currentQuestion === writingQuestions.length - 1 ? "Finish Quiz" : "Next"}
