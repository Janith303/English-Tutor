...
export default function GrammarQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Practice English grammar, sentence rules, and tenses with 10 grammar-focused questions.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/grammar-quiz/play")}
