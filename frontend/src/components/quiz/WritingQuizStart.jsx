...
export default function WritingQuizStart() {
      ...
      <main className="max-w-3xl mx-auto px-6 pt-8 pb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-[#475569] max-w-xl mx-auto">
            Improve your sentence writing, clarity, and written expression with 10 writing-focused English questions.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-md mb-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center gap-3">
              ...
              <span className="text-[#475569]">Explanation is shown after answering</span>
            </li>
            <li className="flex items-center gap-3">
              ...
              <span className="text-[#475569]">You can move between questions</span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/writing-quiz/play")}
