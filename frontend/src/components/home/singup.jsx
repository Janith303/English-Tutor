...
const roles = [
  {
    title: "Student",
    tagline: "Improve your academic English for essays, lectures, and research.",
    img: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1200",
    alt: "Student studying with a laptop",
  },
  {
    title: "Student Tutor",
    tagline: "A SLIIT student? Mentor peers and sharpen your own communication skills.",
    img: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=600",
    alt: "Group of students collaborating",
  },
  {
    title: "Tutor",
    tagline: "An English expert or academic? Join our network to teach global scholars.",
            ...
            >
              ...
              <button 
                className="w-full py-4 bg-blue-600 text-white text-lg font-bold rounded-xl 
                           hover:bg-blue-700 transition shadow-lg active:scale-95 transform group-hover:shadow-blue-200 group-hover:shadow-xl"
              >
