  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 mt-16">
        ...
        {isSubmitted ? (
          /* Application Pending View (Kept original logic) */
          ...
          <div className="w-full max-w-2xl bg-white/95 backdrop-blur-2xl border border-white rounded-[3rem] shadow-2xl p-8 md:p-12 animate-in fade-in slide-in-from-right-8 duration-500">
              ...
              <section className="space-y-2">
                ...
                <div className="flex gap-3">
                  ...
                  {!otpSent && !emailVerified && (
                    <button onClick={handleSendOtp} disabled={!email || loading} className="px-6 bg-slate-900 text-white rounded-2xl font-black text-sm hover:bg-black transition-all">
              ...
              {otpSent && !emailVerified && (
                <section className="animate-in slide-in-from-top-4 duration-300">
                  <div className="p-5 bg-blue-50/50 border-2 border-blue-100 rounded-[2rem] flex gap-3">
                    ...
                    />
                    <button onClick={handleVerifyOtp} className="px-8 bg-blue-600 text-white rounded-2xl font-black transition-all">Verify</button>
                  </div>
                </section>
              )}
            ...
            <div className="mt-10 pt-6 border-t border-slate-100 flex gap-4">
              ...
              <button 
                ...
                disabled={!emailVerified || !idFile || !agreed || !passwordsMatch || password.length < 6 || !fullName || !faculty || !academicYear}
                className="flex-[2] py-4 bg-blue-600 text-white rounded-[1.5rem] font-black text-lg shadow-xl hover:bg-blue-700 transition-all disabled:opacity-20 disabled:cursor-not-allowed"
              >
                Next
              </button>
            </div>
