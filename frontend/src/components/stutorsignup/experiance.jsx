...
import { 
  ...
  Sparkles, ShieldCheck, CheckCircle2, Loader2 // Added missing icons
} from "lucide-react";
...
export default function TutorStepTwo() {
  ...
  const handleFinalSubmit = () => {
    // Removed password checks as they don't exist in Step 2 state
    // You should add your backend API call here
    setIsSubmitted(true);
  };
          ...
          <div className="w-full max-w-3xl bg-white/90 backdrop-blur-2xl border border-white rounded-[3rem] shadow-2xl p-8 md:p-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="space-y-12">
              ...
              <section className="space-y-4">
                ...
                <div onClick={triggerFileInput} className="p-8 border-2 border-dashed rounded-[2rem] flex flex-col items-center justify-center cursor-pointer bg-slate-50 hover:bg-blue-50">
                  {!videoFile ? (
            ...
            <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row gap-4">
              ...
              <button 
                ...
                className="flex-[2] py-5 bg-slate-900 text-white rounded-[1.8rem] font-black disabled:opacity-30"
              >
                Submit Application
              </button>
            </div>
