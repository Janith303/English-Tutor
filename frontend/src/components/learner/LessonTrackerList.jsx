export default function LessonTrackerList({ lessons, earnedCredits, onStartLesson }) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
      ...
      <div className="flex flex-col gap-3">
        {lessons.map((lesson) => {
          const isLocked = !lesson.isUnlocked && earnedCredits < lesson.requiredCreditsToUnlock;
