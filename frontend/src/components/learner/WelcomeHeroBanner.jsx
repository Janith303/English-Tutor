export default function WelcomeHeroBanner({ student }) {
  return (
    <div className="bg-gradient-to-br from-[#2563EB] to-[#3B82F6] rounded-2xl px-8 py-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
      <div>
      ...
      <div className="flex gap-3 flex-shrink-0">
        <div className="bg-white/20 backdrop-blur-sm rounded-xl px-5 py-3 text-white min-w-[140px]">
          <p className="text-white/70 text-xs mb-1">Selected Area</p>
