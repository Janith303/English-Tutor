            ...
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <p className="text-slate-500 mt-2">
                  Let's confirm your university status
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3 bg-slate-50 border text-slate-700 border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-900 uppercase ml-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-900 uppercase ml-1">
                    Faculty
                  </label>
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-5 text-slate-700 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none"
                  />
                </div>
