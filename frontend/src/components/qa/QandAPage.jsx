...
const DUMMY_QUESTIONS = [
  ...
  },
  {
    id: 4,
    title:
      'How should I answer the question "Tell me about yourself" in a job interview?',
      ...
      <main className="max-w-5xl mx-auto py-10 px-6">
        <header className="mb-8">
          ...
          <p className="text-slate-500">
            Ask questions, share knowledge, and learn English together
          </p>
        </header>

        {/* Filters */}
        <div className="flex gap-2 mb-8 bg-white p-1.5 rounded-lg border w-fit shadow-sm">
          {["All Questions", "My Questions", "Unanswered", "Most Upvoted"].map(
            (tab) => (
              <button
                key={tab}
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between text-slate-500 text-sm">
                  <div className="flex items-center gap-2">
                    <img
                      src={`https://ui-avatars.com/api/?name=${q.author}&background=random`}
                      alt={q.author}
                  ...
                  <div className="flex gap-4">
                    <span className="flex items-center gap-1">
                      <MessageSquare size={14} /> {q.answers} answers
                    </span>
                    <span className="flex items-center gap-1">
